namespace Arborescence.Traversal.Incidence
{
    ...
    public static partial class RecursiveDfs<TVertex, TEdge>
    {
        ...
        public static void Traverse<TGraph, THandler>(
            ...
            RecursiveDfs<TVertex, TEdge, IEnumerator<TEdge>>.TraverseChecked(graph, source, handler, cancellationToken);
        ...
        public static void Traverse<TGraph, THandler>(
            ...
            where TGraph : IHeadIncidence<TVertex, TEdge>, IOutEdgesIncidence<TVertex, IEnumerator<TEdge>>
            where THandler : IDfsHandler<TGraph, TVertex, TEdge> =>
            RecursiveDfs<TVertex, TEdge, IEnumerator<TEdge>>.TraverseChecked(

namespace Arborescence.Traversal.Adjacency
{
    ...
    public static partial class EagerDfs<TVertex>
    {
        /// <summary>
        ...
        public static void Traverse<TGraph, THandler>(
            ...
            EagerDfs<TVertex, IEnumerator<TVertex>>.TraverseChecked(graph, source, handler, cancellationToken);
        ...
        public static void Traverse<TGraph, THandler>(
            ...
            where TGraph : IOutNeighborsAdjacency<TVertex, IEnumerator<TVertex>>
            where THandler : IDfsHandler<TVertex, Endpoints<TVertex>, TGraph> =>
            EagerDfs<TVertex, IEnumerator<TVertex>>.TraverseChecked(

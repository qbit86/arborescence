namespace Arborescence.Traversal.Incidence
{
    ...
    public static partial class EnumerableBfs<TVertex, TEdge>
    {
        ...
        public static IEnumerable<TVertex> EnumerateVertices<TGraph, TSourceCollection>(
            ...
            EnumerableBfs<TVertex, TEdge, IEnumerator<TEdge>>.EnumerateVerticesChecked(graph, sources);
        ...
        public static IEnumerable<TVertex> EnumerateVertices<TGraph, TSourceCollection>(
            ...
            where TGraph : IHeadIncidence<TVertex, TEdge>, IOutEdgesIncidence<TVertex, IEnumerator<TEdge>>
            where TSourceCollection : IEnumerable<TVertex> =>
            EnumerableBfs<TVertex, TEdge, IEnumerator<TEdge>>.EnumerateVerticesChecked(graph, sources, comparer);
        ...
        public static IEnumerable<TVertex> EnumerateVertices<TGraph, TSourceCollection, TExploredSet>(
            ...
            EnumerableBfs<TVertex, TEdge, IEnumerator<TEdge>>.EnumerateVerticesChecked(graph, sources, exploredSet);
    }
}

namespace Arborescence.Traversal.Incidence
{
    ...
    public static partial class EnumerableBfs<TVertex, TEdge>
    {
        ...
        public static IEnumerable<TEdge> EnumerateEdges<TGraph>(
            ...
            EnumerableBfs<TVertex, TEdge, IEnumerator<TEdge>>.EnumerateEdgesChecked(graph, source);
        ...
        public static IEnumerable<TEdge> EnumerateEdges<TGraph>(
            ...
            where TGraph : IHeadIncidence<TVertex, TEdge>, IOutEdgesIncidence<TVertex, IEnumerator<TEdge>> =>
            EnumerableBfs<TVertex, TEdge, IEnumerator<TEdge>>.EnumerateEdgesChecked(graph, source, comparer);
        ...
        public static IEnumerable<TEdge> EnumerateEdges<TGraph, TExploredSet>(
            ...
            EnumerableBfs<TVertex, TEdge, IEnumerator<TEdge>>.EnumerateEdgesChecked(graph, source, exploredSet);
    }
}

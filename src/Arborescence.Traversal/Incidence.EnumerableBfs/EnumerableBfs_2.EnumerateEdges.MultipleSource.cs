namespace Arborescence.Traversal.Incidence
{
    ...
    public static partial class EnumerableBfs<TVertex, TEdge>
    {
        ...
        public static IEnumerable<TEdge> EnumerateEdges<TGraph, TSourceCollection>(
            ...
            EnumerableBfs<TVertex, TEdge, IEnumerator<TEdge>>.EnumerateEdgesChecked(graph, sources);
        ...
        public static IEnumerable<TEdge> EnumerateEdges<TGraph, TSourceCollection>(
            ...
            where TGraph : IHeadIncidence<TVertex, TEdge>, IOutEdgesIncidence<TVertex, IEnumerator<TEdge>>
            where TSourceCollection : IEnumerable<TVertex> =>
            EnumerableBfs<TVertex, TEdge, IEnumerator<TEdge>>.EnumerateEdgesChecked(graph, sources, comparer);
        ...
        public static IEnumerable<TEdge> EnumerateEdges<TGraph, TSourceCollection, TExploredSet>(
            ...
            EnumerableBfs<TVertex, TEdge, IEnumerator<TEdge>>.EnumerateEdgesChecked(graph, sources, exploredSet);
    }
}

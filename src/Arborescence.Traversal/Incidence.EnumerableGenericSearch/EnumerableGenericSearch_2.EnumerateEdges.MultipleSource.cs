namespace Arborescence.Traversal.Incidence
{
    ...
    public static partial class EnumerableGenericSearch<TVertex, TEdge>
    {
        ...
        public static IEnumerable<TEdge> EnumerateEdges<
            ...
            EnumerableGenericSearch<TVertex, TEdge, IEnumerator<TEdge>>.EnumerateEdgesChecked(graph, sources, frontier);
        ...
        public static IEnumerable<TEdge> EnumerateEdges<
            ...
            where TSourceCollection : IEnumerable<TVertex>
            where TFrontier : IProducerConsumerCollection<TVertex> =>
            EnumerableGenericSearch<TVertex, TEdge, IEnumerator<TEdge>>.EnumerateEdgesChecked(

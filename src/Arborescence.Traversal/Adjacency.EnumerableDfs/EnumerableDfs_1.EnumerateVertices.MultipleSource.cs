namespace Arborescence.Traversal.Adjacency
{
    ...
    public static partial class EnumerableDfs<TVertex>
    {
        ...
        public static IEnumerator<TVertex> EnumerateVertices<TGraph, TSourceEnumerator>(
            ...
            EnumerableDfs<TVertex, IEnumerator<TVertex>>.EnumerateVerticesChecked(graph, sources);
        ...
        public static IEnumerator<TVertex> EnumerateVertices<TGraph, TSourceEnumerator>(
            ...
            where TGraph : IAdjacency<TVertex, IEnumerator<TVertex>>
            where TSourceEnumerator : IEnumerator<TVertex> =>
            EnumerableDfs<TVertex, IEnumerator<TVertex>>.EnumerateVerticesChecked(graph, sources, comparer);
        ...
        public static IEnumerator<TVertex> EnumerateVertices<TGraph, TSourceEnumerator, TExploredSet>(
            ...
            EnumerableDfs<TVertex, IEnumerator<TVertex>>.EnumerateVerticesChecked(graph, sources, exploredSet);
    }
}

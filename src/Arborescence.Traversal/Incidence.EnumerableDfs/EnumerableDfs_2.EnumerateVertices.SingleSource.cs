namespace Arborescence.Traversal.Incidence
{
    ...
    public static partial class EnumerableDfs<TVertex, TEdge>
    {
        ...
        public static IEnumerable<TVertex> EnumerateVertices<TGraph>(
            ...
            EnumerableDfs<TVertex, TEdge, IEnumerator<TEdge>>.EnumerateVerticesChecked(graph, source);
        ...
        public static IEnumerable<TVertex> EnumerateVertices<TGraph>(
            ...
            where TGraph : IHeadIncidence<TVertex, TEdge>, IOutEdgesIncidence<TVertex, IEnumerator<TEdge>> =>
            EnumerableDfs<TVertex, TEdge, IEnumerator<TEdge>>.EnumerateVerticesChecked(graph, source, comparer);
        ...
        public static IEnumerable<TVertex> EnumerateVertices<TGraph, TExploredSet>(
            ...
            EnumerableDfs<TVertex, TEdge, IEnumerator<TEdge>>.EnumerateVerticesChecked(graph, source, exploredSet);
    }
}

...
### Changed
- Traversal: Made public methods of ``GenericSearch`4``, ``EnumerableBfs`4``, ``EnumerableDfs`3``, ``EnumerableDfs`4`` to be non-iterator, so arguments check takes place eagerly.
